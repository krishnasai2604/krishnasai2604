...
Full Stack Engineer with **5+ years** building production systems in **healthcare and enterprise domains**. I specialize in:

- 🏗️ **Backend**: Java 17, Spring Boot, Spring Cloud, Python, Microservices
- ⚛️ **Frontend**: React.js, Angular, TypeScript, Material UI
- 🤖 **AI/ML**: Predictive analytics, anomaly detection, real-time scoring pipelines
- ☁️ **Cloud**: AWS Certified (Solutions Architect + Developer Associate)

Currently at **CVS Health**, building an AI-driven claims risk platform that processes **$2B+ in annual transactions** — reducing manual reviews by 35% and adjudication time by 40%.
...
### 🏥 CVS Health — Full Stack Engineer, AI & Claims Platform *(Aug 2024 – Present)*
- 🤖 Built AI-driven healthcare claims risk platform — **35% fewer manual reviews**, **40% faster adjudication**
...
- 🧪 Created 200+ request Postman regression suite — caught **15+ breaking changes** pre-deploy
- 📐 Produced 20+ system diagrams enabling **2x faster onboarding** for new engineers

---

## 🎓 Education & Certifications

**M.S. Computer Science** — Concordia University, Mequon, WI *(GPA: 3.6/4.0)*
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=krishnasai2604&label=Profile%20views&color=0e75b6&style=flat" alt="Profile views"/>
</p>

<p align="center">
  <i>"Building systems that scale, heal faster, and ship faster — one commit at a time."</i>
</p>
